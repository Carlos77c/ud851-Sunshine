...
public class WeatherProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        uriMatcher.addURI(contentAuthority, WeatherContract.PATH_WEATHER, CODE_WEATHER);
        uriMatcher.addURI(contentAuthority, WeatherContract.PATH_WEATHER + "/#", CODE_WEATHER_WITH_DATE);
        return uriMatcher;
    }
