...
//      COMPLETED (21) Implement LoaderManager.LoaderCallbacks<Cursor>
    ...
    TextView mWeatherHighTv;
    TextView mWeatherLowTv;
    TextView mWeatherHumidityTv;
    TextView mWeatherWindTv;
    TextView mWeatherPressureTv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWeatherDateTv = findViewById(R.id.tv_display_weather_date);
        mWeatherDescTv = findViewById(R.id.tv_display_weather_desc);
        mWeatherHighTv = findViewById(R.id.tv_display_weather_high);
        mWeatherLowTv = findViewById(R.id.tv_display_weather_low);
        mWeatherHumidityTv = findViewById(R.id.tv_display_weather_humidity);
        mWeatherWindTv = findViewById(R.id.tv_display_weather_wind);
        mWeatherPressureTv = findViewById(R.id.tv_display_weather_pressure);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        String dateText = SunshineDateUtils.getFriendlyDateString(this, data.getLong(INDEX_WEATHER_DATE), true);
        mWeatherDateTv.setText(dateText);
        ...
        mWeatherDescTv.setText(description);

        // COMPLETED (28) Display the high temperature
        String highString = SunshineWeatherUtils.formatTemperature(this, data.getDouble(INDEX_WEATHER_MAX_TEMP));
        mWeatherHighTv.setText(highString);

        // COMPLETED (29) Display the low temperature
        String lowString = SunshineWeatherUtils.formatTemperature(this, data.getDouble(INDEX_WEATHER_MIN_TEMP));
        mWeatherLowTv.setText(lowString);

        // COMPLETED (30) Display the humidity
        String humidityString = getString(R.string.format_humidity, data.getFloat(INDEX_WEATHER_HUMIDITY));
        mWeatherHumidityTv.setText(humidityString);
        ...
        mWeatherWindTv.setText(windString);

         // COMPLETED (32) Display the pressure
        String pressureString = getString(R.string.format_pressure, data.getFloat(INDEX_WEATHER_PRESSURE));
        mWeatherPressureTv.setText(pressureString);
